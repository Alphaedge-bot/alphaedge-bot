AlphaEdge V13.0.5 – Complete Master Design
...
1. Bot Identity & Core Principles
2. Hardware Architecture
3. Complete Agent List
4. Strategy Pipeline
5. Scoring Systems
6. Wallet Structure
7. Gold Swap Strategy
8. Risk Management
9. RPC Configuration
10. Deployment
...
Tier Range Max Positions
Micro Cap <$50M 2-6 (1.15x multiplier)
Small Cap $50M-200M 4-10
Mid Cap $200M-1B 4-12
...
3. Momentum-only breakout strategy
...
31. Gold backup (PAXG) if both USDC and USDT depeg
...
18 Risk Guardian Hard veto, VaR/ES, dynamic hedging
...
30 Self-Evolving Proposes code improvements
...
56 Optimizer Engine Bayesian optimization
...
63 Profit Taking Executor Execute orders, gold swaps
...
69 Momentum Rotator Monitor TPS scores
