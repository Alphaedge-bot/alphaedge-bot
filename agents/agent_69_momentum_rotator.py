...
Entry ≥82, Exit ≤68
V13.0.6 – UPDATED with ICT/SMC Zone Integration + MCDX + Smart Money Concepts
"""
...
class MomentumRotator:
    ...
    def __init__(self, event_bus: EventBus, state_manager: StateManager):
        ...
        # ============================================
        # Zone Detector for TPS Enhancement
        # ============================================
        ...
        # ============================================
        # Smart Money Concepts Detector (NEW)
        # ============================================
    ...
    async def handle_tps_update(self, event: Event):
        ...
        if ticker:
            ...
            # ============================================
            # Zone adjustment for this ticker
            # ============================================
            ...
            # ============================================
            # MCDX adjustment for this ticker
            # ============================================
            ...
            # ============================================
            # NEW: Smart Money Concepts adjustment
            # ============================================
            ...
            if smc_adjustment != 0:
                ...
                logger.debug(f"SMC adjustment for {ticker}: {smc_adjustment:.1f}")
            
            # Calculate final adjusted TPS
            adjusted_tps = tps + zone_adjustment + mcdx_adjustment + smc_adjustment
    ...
    # ============================================
    # NEW: Smart Money Concepts Methods
    # ============================================
    ...
    async def _calculate_smc_tps_adjustment(self, price_data: Dict) -> float:
        ...
        try:
            ...
            logger.error(f"SMC TPS adjustment error: {e}")
            return 0.0
    ...
    async def publish_rotation_update(self):
        ...
        if self.last_smc_signal:
            smc_summary = {
                ...
                'bearish_ob_validated': False,
                'has_breaker': self.last_smc_signal.bullish_breaker or self.last_smc_signal.bearish_breaker,
                'has_ifvg': self.last_smc_signal.bullish_ifvg or self.last_smc_signal.bearish_ifvg,
                'cisd_bullish': self.last_smc_signal.cisd_bullish,
                'cisd_bearish': self.last_smc_signal.cisd_bearish,
                'inducement_triggered': self.last_smc_signal.inducement_triggered,
                'bullish_ote': self.last_smc_signal.bullish_ote,
                'bearish_ote': self.last_smc_signal.bearish_ote
            }
    ...
    async def get_status(self) -> Dict[str, Any]:
        ...
        if self.last_smc_signal:
            smc_status = {
                'confluence_score': self.last_smc_signal.confluence_score,
                'trend_bias': self.last_smc_signal.trend_bias,
                'ob_validated': self.last_smc_signal.ob_validation.is_valid() if self.last_smc_signal.ob_validation else False,
                'has_breaker': self.last_smc_signal.bullish_breaker or self.last_smc_signal.bearish_breaker,
                'has_ifvg': self.last_smc_signal.bullish_ifvg or self.last_smc_signal.bearish_ifvg,
                'cisd_bullish': self.last_smc_signal.cisd_bullish,
                'cisd_bearish': self.last_smc_signal.cisd_bearish
